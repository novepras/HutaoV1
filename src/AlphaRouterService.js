...
const V3_SWAP_ROUTER_ADDRES = '0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45'
const REACT_APP_INFURA_URL_TESTNET = process.env.REACT_APP_INFURA_URL_TESTNET

const chainId = 5;

const web3Provider = new ethers.providers.JsonRpcProvider('https://goerli.infura.io/v3/5cb749f3b71046528e476350d4bc4226')
